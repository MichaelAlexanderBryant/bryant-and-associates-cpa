function AboutIndex() {
    return (
        <>
            ...
            <h2><a className="about-item" href="/bryant-and-associates-cpa/#/about/our-values">Our Values</a></h2>
            <p>Our firm provides outstanding service to our clients because of our dedication to the three underlying principles.</p>
            <h2><a className="about-item" href="/bryant-and-associates-cpa/#/about/our-team">Our Team</a></h2>
