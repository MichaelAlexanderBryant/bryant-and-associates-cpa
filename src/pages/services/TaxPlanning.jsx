function TaxPlanning() {
    return (
        <div>
            ...
            <p>Businesses and individuals pay the lowest amount of taxes allowable by law because we continually look for ways to minimize your taxes throughout the year, not just at the end of the year.</p>
            <p>We recommend <span className="list-bold">Tax Saving Strategies</span> that help you...</p>
            <ul>
            ...
            <p>Here's just a few of the <span className="list-bold">Tax Saving Strategies</span> we use...</p>
            <ul>
            ...
            <p>If you'd like to receive more information about our Tax Planning Service, please give us a call.</p>
        </div>
    )
}
