    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li><span className="list-bold">It's a Time Saver</span>: Our payroll service eliminates the burden of customizing, updating and maintaining your own payroll system--no more data entry, no more researching updates or new laws, no more worries.
                </li>
                <li><span className="list-bold">Worry Free Payroll Tax Filing</span>: Eliminate the risks of calculating and filing your own payroll taxes by having professionals do it for you. Federal, state and local payroll tax laws are frequently changing and becoming more complex.  How much time do you want to spend  learning all the rules and keeping your information up to date?
                </li>
                <li><span className="list-bold">Allows You To Focus On Core Competencies</span>: Our professional staff allow you to focus on the core competencies of your business. We are accounting professionals--you get the experts working for you and with you.
                </li>
            ...
            <ol>
                <li><span className="list-bold">Comprehensive Payroll Services</span>: Our Comprehensive Payroll Service takes care of all of the payroll processing for you, so that you won't have to. You get...
                    <ul>
                        <li>Your payroll checks printed or direct deposits initiated.</li>
                        <li>Monthly, quarterly, and annual payroll tax reporting, including W-2s.</li>
                        <li>Worry Free IRS and State payroll tax payment scheduling.</li>
                        <li>Your payroll records maintained in tip top shape.</li>
                    </ul>

                </li>
                <li><span className="list-bold">After-the-Fact-Payroll Services</span>: We will take your manually-prepared payroll records and other payroll information and post this information to our data files, so you get...
                    <ul>
                        <li>Monthly, quarterly, and annual payroll tax reporting, including W-2s.</li>
                        <li>Worry Free IRS and State payroll tax payment scheduling.</li>
                        <li>Your payroll records maintained in tip top shape.</li>
                ...
                <li><span className="list-bold">Online Payroll Processing</span>: You can enter your employee's hours and earnings securely online and get...
                    <ul>
                        <li>The ability to print your payroll checks or initiate your direct deposits.</li>
                        <li>Monthly, quarterly, and annual payroll tax reporting, including W-2s.</li>
                        <li>Worry Free IRS and State payroll tax payment scheduling.</li>
                        <li>Your payroll records maintained in tip top shape.</li>
                    </ul>
            ...
            <ul>
                ...
                <li>Social Security Audits</li>
                <li>Child Support Audits</li>
