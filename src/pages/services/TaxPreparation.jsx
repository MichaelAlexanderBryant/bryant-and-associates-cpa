function TaxPreparation() {
    return (
        <div>
            ...
            <p className="list-bold">Here's what you get...</p>
            <ul>
            ...
            <p>If you'd like to receive more information about our Tax Preparation Service, please give us a call.</p>
        </div>
    )
}
